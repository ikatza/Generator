...
#include "Physics/DarkNeutrino/XSection/AhrensDNuELPXSec.h"
...
//____________________________________________________________________________
AhrensDNuELPXSec::AhrensDNuELPXSec() :
XSecAlgorithmI("genie::AhrensDNuELPXSec")
{

}
//____________________________________________________________________________
AhrensDNuELPXSec::AhrensDNuELPXSec(string config) :
XSecAlgorithmI("genie::AhrensDNuELPXSec", config)
{
    ...
    const Interaction * interaction, KinePhaseSpace_t kps) const
{
  ...
  LOG("AhrensDNuEL", pDEBUG) << "Using v^" << fVelMode << " dependence";
  ...
  LOG("AhrensDNuEL", pNOTICE) << "Form factor masses are " << fMv2 << ", " << fMa2;
  ...
  LOG("AhrensDNuEL", pNOTICE) << "Calculating for nuclear sign " << nucsign;
...
//____________________________________________________________________________
double AhrensDNuELPXSec::Integral(const Interaction * interaction) const
{
  double xsec = fXSecIntegrator->Integrate(this,interaction);
  return xsec;
}
//____________________________________________________________________________
bool AhrensDNuELPXSec::ValidProcess(const Interaction * interaction) const
{
  if(interaction->TestBit(kISkipProcessChk)) return true;
  return true;
}
//____________________________________________________________________________
void AhrensDNuELPXSec::Configure(const Registry & config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void AhrensDNuELPXSec::Configure(string config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void AhrensDNuELPXSec::LoadConfig(void)
{
  ...
  this->GetParam( "DNuEL-Mp", mp ) ;
  this->GetParam( "DNuEL-Mpi", mpi ) ;
  this->GetParam( "DNuEL-Meta", meta ) ;
