...
#ifndef _DNu_ELECTRON_XSEC_H_
#define _DNu_ELECTRON_XSEC_H_

#include "Physics/XSectionIntegration/XSecIntegratorI.h"

namespace genie {

class DNuElectronXSec : public XSecIntegratorI {

public:
  DNuElectronXSec();
  DNuElectronXSec(string config);
  virtual ~DNuElectronXSec();
