...
#ifndef _DNu_BODEK_YANG_STRUCTURE_FUNCTION_MODEL_H_
#define _DNu_BODEK_YANG_STRUCTURE_FUNCTION_MODEL_H_
...
class DNuBYStrucFunc : public QPMDNuDISStrucFuncBase {

public:
  DNuBYStrucFunc();
  DNuBYStrucFunc(string config);
  virtual ~DNuBYStrucFunc();
...
#endif    // _DNu_BODEK_YANG_STRUCTURE_FUNCTION_MODEL_H_
