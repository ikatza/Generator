...
\class    genie::QPMDNuDISStrucFuncBase
...
#ifndef _DNu_QPM_DIS_STRUCTURE_FUNCTIONS_BASE_H_
#define _DNu_QPM_DIS_STRUCTURE_FUNCTIONS_BASE_H_
...
class QPMDNuDISStrucFuncBase : public DISStructureFuncModelI {

public:
  virtual ~QPMDNuDISStrucFuncBase();
...
protected:
  QPMDNuDISStrucFuncBase();
  QPMDNuDISStrucFuncBase(string name);
  QPMDNuDISStrucFuncBase(string name, string config);

  // commom code for SF calculation for all DISFormFactorsModelI
  // interface implementations inheriting from QPMDNuDISStrucFuncBase
