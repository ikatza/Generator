...
#include "Physics/DarkNeutrino/XSection/QPMDNuDISStrucFuncBase.h"
...
//____________________________________________________________________________
QPMDNuDISStrucFuncBase::QPMDNuDISStrucFuncBase() :
DISStructureFuncModelI()
{
  this->InitPDF();
}
//____________________________________________________________________________
QPMDNuDISStrucFuncBase::QPMDNuDISStrucFuncBase(string name) :
DISStructureFuncModelI(name)
{
  this->InitPDF();
}
//____________________________________________________________________________
QPMDNuDISStrucFuncBase::QPMDNuDISStrucFuncBase(string name, string config):
...
//____________________________________________________________________________
void QPMDNuDISStrucFuncBase::Configure(const Registry & config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void QPMDNuDISStrucFuncBase::Configure(string param_set)
{
  Algorithm::Configure(param_set);
  this->LoadConfig();
}
//____________________________________________________________________________
void QPMDNuDISStrucFuncBase::LoadConfig(void)
{
...
//____________________________________________________________________________
void QPMDNuDISStrucFuncBase::InitPDF(void)
{
                     // evaluated at:
...
//____________________________________________________________________________
void QPMDNuDISStrucFuncBase::Calculate(const Interaction * interaction) const
{
...
//____________________________________________________________________________
double QPMDNuDISStrucFuncBase::Q2(const Interaction * interaction) const
{
...
//____________________________________________________________________________
double QPMDNuDISStrucFuncBase::ScalingVar(const Interaction* interaction) const
{
...
//____________________________________________________________________________
void QPMDNuDISStrucFuncBase::KFactors(const Interaction *, 
...
//____________________________________________________________________________
double QPMDNuDISStrucFuncBase::NuclMod(const Interaction * interaction) const
{
...
//____________________________________________________________________________
double QPMDNuDISStrucFuncBase::R(const Interaction * interaction) const
{
...
//____________________________________________________________________________
void QPMDNuDISStrucFuncBase::CalcPDFs(const Interaction * interaction) const
{
