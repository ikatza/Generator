...
#ifndef _DNu_ELECTRON_PARTIAL_XSEC_H_
#define _DNu_ELECTRON_PARTIAL_XSEC_H_
...
class DNuElectronPXSec : public XSecAlgorithmI {

public:
  DNuElectronPXSec();
  DNuElectronPXSec(string config);
  virtual ~DNuElectronPXSec();
...
#endif  // _DNu_ELECTRON_PARTIAL_XSEC_H_
