...
/*
 ...
 @ Oct 09, 2009 - CA
   Renamed to DNuBYStrucFunc from DNuBYStructureFuncModel
...
#include "Physics/DarkNeutrino/XSection/DNuBYStrucFunc.h"
...
//____________________________________________________________________________
DNuBYStrucFunc::DNuBYStrucFunc() :
QPMDNuDISStrucFuncBase("genie::DNuBYStrucFunc")
{
  this->Init();
}
//____________________________________________________________________________
DNuBYStrucFunc::DNuBYStrucFunc(string config):
QPMDNuDISStrucFuncBase("genie::DNuBYStrucFunc", config)
{
  this->Init();
}
//____________________________________________________________________________
...
//____________________________________________________________________________
void DNuBYStrucFunc::Configure(const Registry & config)
{
// Overload Algorithm::Configure() to read the config. registry and set
// private data members.
// QPMDNuDISStrucFuncBase::Configure() creates the owned PDF object that gets
// configured with the specified PDFModelI
// For the ReadBYParams() method see below

  QPMDNuDISStrucFuncBase::Configure(config);
  this->ReadBYParams();
}
//____________________________________________________________________________
void DNuBYStrucFunc::Configure(string param_set)
{
  QPMDNuDISStrucFuncBase::Configure(param_set);
  this->ReadBYParams();
}
//____________________________________________________________________________
void DNuBYStrucFunc::ReadBYParams(void)
{
...
//____________________________________________________________________________
double DNuBYStrucFunc::ScalingVar(const Interaction * interaction) const
{
// Overrides QPMDNuDISStrucFuncBase::ScalingVar() to compute the BY scaling var
...
//____________________________________________________________________________
void DNuBYStrucFunc::KFactors(const Interaction * interaction, 
	         double & kuv, double & kdv, double & kus, double & kds) const
{
// Overrides QPMDNuDISStrucFuncBase::KFactors() to compute the BY K factors for
