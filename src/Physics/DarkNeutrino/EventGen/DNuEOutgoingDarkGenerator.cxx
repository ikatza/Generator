...
#include "Physics/DarkNeutrino/EventGen/DNuEOutgoingDarkGenerator.h"
...
DNuEOutgoingDarkGenerator::DNuEOutgoingDarkGenerator() :
OutgoingDarkGenerator("genie::DNuEOutgoingDarkGenerator")
{

}
//___________________________________________________________________________
DNuEOutgoingDarkGenerator::DNuEOutgoingDarkGenerator(string config):
OutgoingDarkGenerator("genie::DNuEOutgoingDarkGenerator", config)
{
...
//___________________________________________________________________________
void DNuEOutgoingDarkGenerator::ProcessEventRecord(GHepRecord * evrec) const
{
// This method generates the final state primary lepton for DNuE events
