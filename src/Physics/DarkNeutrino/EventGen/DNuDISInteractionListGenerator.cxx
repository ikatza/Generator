...
#include "Physics/DarkNeutrino/EventGen/DNuDISInteractionListGenerator.h"
...
DNuDISInteractionListGenerator::DNuDISInteractionListGenerator() :
InteractionListGeneratorI("genie::DNuDISInteractionListGenerator")
{

}
//___________________________________________________________________________
DNuDISInteractionListGenerator::DNuDISInteractionListGenerator(string config) :
InteractionListGeneratorI("genie::DNuDISInteractionListGenerator", config)
{
...
//___________________________________________________________________________
InteractionList * DNuDISInteractionListGenerator::CreateInteractionList(
                                      const InitialState & init_state) const
{
  ...
  // Only accept DNu scattering here
  if (fIsDNu) inttype = kIntDarkMatter;
  else {
     LOG("IntLst", pWARN)
...
//___________________________________________________________________________
void DNuDISInteractionListGenerator::Configure(const Registry & config)
{
  Algorithm::Configure(config);
  this->LoadConfigData();
}
//____________________________________________________________________________
void DNuDISInteractionListGenerator::Configure(string config)
{
  Algorithm::Configure(config);
  this->LoadConfigData();
}
//____________________________________________________________________________
void DNuDISInteractionListGenerator::LoadConfigData(void)
{
...
//____________________________________________________________________________
multimap<int,bool> DNuDISInteractionListGenerator::GetHitQuarks(
