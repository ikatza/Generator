...
#include "Physics/DarkNeutrino/EventGen/DNuETargetRemnantGenerator.h"
...
DNuETargetRemnantGenerator::DNuETargetRemnantGenerator() :
EventRecordVisitorI("genie::DNuETargetRemnantGenerator")
{

}
//___________________________________________________________________________
DNuETargetRemnantGenerator::DNuETargetRemnantGenerator(string config) :
EventRecordVisitorI("genie::DNuETargetRemnantGenerator", config)
{
...
//___________________________________________________________________________
void DNuETargetRemnantGenerator::ProcessEventRecord(GHepRecord * evrec) const
{
  this -> AddElectronNeutrino     (evrec);
  this -> AddTargetNucleusRemnant (evrec);
}
//___________________________________________________________________________
void DNuETargetRemnantGenerator::AddElectronNeutrino(GHepRecord * evrec) const
{
  ...
  LOG("DNuETargetRemnant", pINFO) << "Adding final state lepton from e- vtx";
...
//___________________________________________________________________________
void DNuETargetRemnantGenerator::AddTargetNucleusRemnant(
                                                    GHepRecord * evrec) const
{
// add the remnant nuclear target at the GHEP record

  LOG("DNuETargetRemnant", pDEBUG) << "Adding final state nucleus";
